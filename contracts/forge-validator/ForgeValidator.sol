...
import { IForgeValidator, TokenStructs } from "./IForgeValidator.sol";
...
contract ForgeValidator is IForgeValidator {
    ...
    ****************************************/
    ...
    /**
     * After the redeemed bAssets have been removed from the basket, determine
     ...
     * underWeight              Array of bools - is this bAsset now under min weight
     */
